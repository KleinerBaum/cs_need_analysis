...
_TRANSLATIONS_EN: dict[str, str] = {
    ...
    "Recruiting-Briefing vor Workflow": "Recruiting-Briefing before workflow",
    ...
    "Starten Sie mit einer Quelle und erhalten Sie zuerst ein Recruiting-Briefing, nicht ein Formular.": "Start with a source and get a Recruiting-Briefing first, not a form.",
    ...
    "Das Eisberg-Modell zeigt, welche sichtbaren und verdeckten Informationen ein gutes Recruiting-Briefing zusammenführt.": "The iceberg model shows which visible and hidden information a strong Recruiting-Briefing brings together.",
    "Von der Jobspec zum belastbaren Recruiting-Briefing": "From jobspec to reliable Recruiting-Briefing",
    ...
    "AI- & ESCO-gestütztes Recruiting-Briefing": "AI- and ESCO-supported Recruiting-Briefing",
    ...
    "Vom Upload zum Recruiting-Briefing": "From upload to Recruiting-Briefing",
    ...
    "Warum Recruiting-Briefing?": "Why Recruiting-Briefing?",
    ...
    "Vor der Verarbeitung können sensible personenbezogene Angaben optional reduziert werden. Ziel ist ein datensparsames, nachvollziehbares Recruiting-Briefing.": "Before processing, sensitive personal information can optionally be reduced. The goal is a data-minimizing, traceable Recruiting-Briefing.",
    ...
    "Recruiting-Briefing vorbereiten": "Prepare Recruiting-Briefing",
    ...
    "Prüfen Sie jetzt die Briefing-Basis, schließen Sie Lücken und bestätigen Sie den Referenzberuf. Danach wird daraus ein belastbares Recruiting-Briefing.": "Review the briefing basis, close gaps, and confirm the reference occupation. Then it becomes a reliable Recruiting-Briefing.",
