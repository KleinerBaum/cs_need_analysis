...
_TRANSLATIONS_EN: dict[str, str] = {
    ...
    "3. Outputs vorbereiten": "3. Prepare outputs",
    "Briefing, Stellenanzeige, Interview-Sheets und Search-Unterlagen nutzen dieselbe Faktenbasis.": "Briefing, job ad, interview sheets, and search material use the same fact base.",
    ...
    "Optional: Im nächsten Abschnitt können Sie den Referenzberuf bestätigen, damit Aufgaben, Skills und Folge-Outputs konsistent bleiben.": "Optional: In the next section, you can confirm the reference occupation so tasks, skills, and downstream outputs stay consistent.",
