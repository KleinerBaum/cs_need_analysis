...
_TRANSLATIONS_EN: dict[str, str] = {
    ...
    "Das Eisberg-Modell zeigt, welche sichtbaren und verdeckten Informationen eine gute Vakanzerfassung zusammenführt.": "The iceberg model shows which visible and hidden information a strong vacancy intake brings together.",
    "Von der Vakanzbeschreibung zur echten Recruitment-Need-Analysis": "From vacancy description to true recruitment need analysis",
    ...
    "AI- & ESCO-optimierte Need-Analysis": "AI- and ESCO-optimized need analysis",
    ...
    "Warum Recruiting-Briefing?": "Why vacancy intake?",
    ...
    "Vor der Verarbeitung können sensible personenbezogene Angaben optional reduziert werden. Ziel ist ein datensparsames, nachvollziehbares Recruiting-Briefing.": "Before processing, sensitive personal information can optionally be reduced. The goal is data-minimizing, traceable vacancy intake.",
