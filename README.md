...
- In **Benefits & Rahmenbedingungen** ist der Salary-Forecast als eigener Block im Schritt integriert (ohne zusätzliche Grafiken): erkannte Benefits können ein-/abgewählt werden und fließen zusammen mit Suchradius, Remote-Anteil und Erfahrung per **„Prognose aktualisieren“** in die Gehaltsprognose ein.
