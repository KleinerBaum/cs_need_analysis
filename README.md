...
- In **Benefits & Rahmenbedingungen** wird der Salary-Forecast direkt im Schritt (ohne zusätzlichen Expander) unter dem **Minimalprofil** angezeigt; erkannte Benefits können in einer Tabelle ein-/abgewählt werden und fließen dann in die Prognose-Berechnung ein.
