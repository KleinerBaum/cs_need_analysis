...
BASE_CORE_PACK = QuestionPack(
    ...
    entries=(
        ...
        _pack_entry(
            ...
            rationale="Defines role success evidence for brief framing and interview calibration.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Anchors the primary business outcome behind role scope and downstream artifacts.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Separates immediate operating tasks from later expansion scope.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            rationale="Keeps later or optional scope out of must-have requirements.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
            ],
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Turns success criteria into timed expectations for interviews and onboarding context.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            rationale="Adds longer-horizon success context without changing day-one requirements.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_INTERVIEW,
            ],
        ...
        _pack_entry(
            ...
            rationale="Clarifies seniority and autonomy for calibration, salary, and interview focus.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Separates start-critical skills from learnable ramp-up expectations.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            rationale="Identifies hard filters that should survive sourcing, screening, and exports.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            rationale="Prevents trainable requirements from being treated as hard candidate filters.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            rationale="Explains why a non-normalized requirement should remain in the vacancy record.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_EXPORT,
            ],
        ...
        _pack_entry(
            ...
            rationale="Clarifies compensation mechanics that affect salary framing and offer artifacts.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Defines the contractual model for exports, salary interpretation, and constraints.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Defines employment volume and type for job ad, salary, and contract artifacts.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            rationale="Captures formal employment constraints that affect salary and exports.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            rationale="Clarifies whether candidate eligibility constraints should shape sourcing and artifacts.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            rationale="Identifies offer elements that affect candidate messaging and compensation context.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
        ...
        _pack_entry(
            ...
            required=True,
            rationale="Defines start-date flexibility for candidate communication and process planning.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
...
DIGITAL_PRODUCT_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Defines the owned digital surface so responsibilities and interviews match the role.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
        ...
        _pack_entry(
            ...
            rationale="Separates start-critical technology requirements from optional stack exposure.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
CLINICAL_PHYSICIAN_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Defines clinical specialty context before license and patient requirements are exported.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
        ...
        _pack_entry(
            ...
            rationale="Captures mandatory medical authorization before screening or export.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
NURSING_CARE_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="domain_expertise",
            fact_key=FactKey.ROLE_DOMAIN_EXPERTISE,
            rationale="Defines the care setting that shapes duties, qualifications, and interviews.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
        ...
        _pack_entry(
            ...
            target_path="certifications",
            fact_key=FactKey.SKILLS_CERTIFICATIONS,
            rationale="Captures mandatory nursing or care qualification requirements.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
FIELD_SALES_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Defines sales territory and account context for role scope and compensation calibration.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            rationale="Clarifies sales compensation mechanics for salary and offer artifacts.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
...
FIELD_SERVICE_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Defines service territory and job types for mobile field-service scope.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
        ...
        _pack_entry(
            ...
            target_path="certifications",
            fact_key=FactKey.SKILLS_CERTIFICATIONS,
            rationale="Captures mandatory safety, equipment, and tool requirements for screening.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
TRANSPORT_LOGISTICS_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Defines route and shift structure for logistics responsibilities and candidate fit.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
CUSTOMER_SUPPORT_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Defines support channels and escalation model for responsibilities and interview evidence.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
DRIVING_REQUIRED_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Captures mandatory mobility requirements that affect screening and exports.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
TRAVEL_HIGH_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="travel_required",
            fact_key=FactKey.ROLE_TRAVEL_REQUIRED,
            rationale="Clarifies travel load and geography for compensation, messaging, and fit checks.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
REGULATED_PROFESSION_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="certifications",
            fact_key=FactKey.SKILLS_CERTIFICATIONS,
            rationale="Captures formal requirements that must be confirmed before screening or export.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SHIFT_ONCALL_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Clarifies shift and on-call expectations for salary, messaging, and candidate fit.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
HIRING_REPLACEMENT_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Adds backfill context that changes responsibilities and interview calibration.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_INTERVIEW,
            ],
...
URGENCY_HIGH_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Defines which process tradeoffs are allowed when hiring urgency is high.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
...
HIRING_VOLUME_MULTI_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Keeps multi-hire evaluation criteria consistent across candidates and roles.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
            ],
...
CONTRACT_CONSTRAINTS_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path=FactKey.BENEFITS_COLLECTIVE_AGREEMENT_CONTEXT.value,
            fact_key=FactKey.BENEFITS_COLLECTIVE_AGREEMENT_CONTEXT,
            rationale="Captures non-standard contractual constraints before offer and export generation.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_EXPORT,
...
INTERNATIONAL_CONTEXT_PACK = QuestionPack(
    ...
    entries=(
        ...
        _pack_entry(
            ...
            target_path=FactKey.LEGAL_WORK_AUTHORIZATION_SUPPORT.value,
            fact_key=FactKey.LEGAL_WORK_AUTHORIZATION_SUPPORT,
            rationale="Clarifies international payroll and authorization limits for sourcing and exports.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_DOMAIN_KNOWLEDGE_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="domain_expertise",
            fact_key=FactKey.ROLE_DOMAIN_EXPERTISE,
            rationale="Confirms domain-knowledge requirements from the ESCO context for this vacancy.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
...
SKILL_GROUP_TOOLS_METHODS_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="tech_stack",
            fact_key=FactKey.ROLE_TECH_STACK,
            rationale="Confirms required tools, systems, or methods from the ESCO context.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_REGULATION_SAFETY_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="certifications",
            fact_key=FactKey.SKILLS_CERTIFICATIONS,
            rationale="Confirms safety, compliance, or qualification requirements from the ESCO context.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_CUSTOMER_CLIENT_INTERACTION_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Confirms direct customer, client, or stakeholder interaction for the role.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_DOCUMENTATION_REPORTING_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Confirms documentation and reporting duties that affect role and interview design.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
...
SKILL_GROUP_LEADERSHIP_COORDINATION_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Confirms leadership or coordination scope from the ESCO context.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_PHYSICAL_MANUAL_CONTEXT_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="responsibilities",
            fact_key=FactKey.ROLE_RESPONSIBILITIES,
            rationale="Confirms physical, manual, or environmental work demands for fit and exports.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_DIGITAL_DATA_AI_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="tech_stack",
            fact_key=FactKey.ROLE_TECH_STACK,
            rationale="Confirms digital, data, automation, or AI requirements from the ESCO context.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SALARY,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
...
SKILL_GROUP_LANGUAGE_COMMUNICATION_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            rationale="Confirms language and communication requirements for screening and exports.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
                QUESTION_IMPACT_TARGET_EXPORT,
...
SKILL_GROUP_TRANSVERSAL_FIT_PACK = QuestionPack(
    ...
    entries=(
        _pack_entry(
            ...
            target_path="success_metrics",
            fact_key=FactKey.ROLE_SUCCESS_METRICS,
            rationale="Adds working-style context when transversal fit needs deeper validation.",
            impact_targets=[
                QUESTION_IMPACT_TARGET_BRIEF,
                QUESTION_IMPACT_TARGET_SKILLS,
                QUESTION_IMPACT_TARGET_INTERVIEW,
