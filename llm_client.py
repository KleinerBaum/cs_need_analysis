...
from llm_structured_outputs import (
    StructuredOutputDependencies,
    _normalize_usage_dict,
    _parse_with_structured_outputs as _parse_with_structured_outputs_impl,
    _record_openai_usage_event as _record_openai_usage_event_impl,
)
from llm_transport import (
    _build_openai_client,
    _build_openai_client_from_runtime_settings,
    _get_cached_openai_client,
    _has_any_openai_api_key,
    _raise_missing_api_key_hint,
    _run_openai_call_with_retry as _transport_run_openai_call_with_retry,
    _safe_hash,
    get_openai_client,
)
...
def _record_openai_usage_event(
    *,
    ...
    """Compatibility facade for centralized OpenAI usage metadata recording."""

    _record_openai_usage_event_impl(
...
def _run_openai_call_with_retry(
    *,
    ...
    """Run OpenAI call with retry while preserving the llm_client facade hook."""

    return _transport_run_openai_call_with_retry(
        fn=fn,
        label=label,
...
def _parse_with_structured_outputs(
    *,
    ...
    """Compatibility facade for centralized structured-output parsing."""

    return _parse_with_structured_outputs_impl(
        runtime_config=runtime_config,
        messages=messages,
        out_model=out_model,
        store=store,
        dependencies=StructuredOutputDependencies(
            ...
            has_any_openai_api_key=_has_any_openai_api_key,
            raise_missing_api_key_hint=_raise_missing_api_key_hint,
            run_openai_call_with_retry=_run_openai_call_with_retry,
            session_state=st.session_state,
        ),
